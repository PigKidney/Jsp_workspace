...
<body>
	...
	<dl>
		...
		<dd>이 페이지를 읽게되는 클라이언트의 웹 브라우저가 이 페이지를 해석할 때 사용할 charset 설정</dd>
		...
		<dd>우리가 Ctrl + S를 눌러서 이클립스를 통해 하드디스크에 저장할 때 사용하는 charset
	...
	<ol>
		<li>GET 방식 피라미터 값은 URL에 포함되어 전달되고 그 URL의 해석은 서버가 담당한다.</li>
	...
	POST : 
	<input type="text" name="animal" value="청룡" form="form2">
