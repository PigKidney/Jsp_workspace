...
<body>
	...
	<dl>
		...
		<dd>WAS에 저장해놓는 어트리뷰트. 서버가 종료되기 전까지 계속 유지된다. 모든 서블릿에서 접근할 수 있다 (전역 static 변수같은 느낌)</dd>
	...
	<input id="requesInput" type="text" value="orange" name="food">
	...
	<script type="text/javascript">
		...
		const requestInput = document.getElementById("requesInput");
